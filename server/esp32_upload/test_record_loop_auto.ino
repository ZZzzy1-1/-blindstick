...
// 测试参数 - 3秒录音
#define TEST_RECORD_TIME_MS 3000  // 录音3秒
...
void setup() {
    ...
    Serial.println("\n========================================");
    Serial.println("  MQTT录音回环测试 - 自动循环模式");
    Serial.println("========================================\n");
...
// ==================== 测试任务 - 自动循环 ====================
void testRecordAndPlaybackTask(void* pvParameters) {
    const int bufferSize = SAMPLE_RATE * 2 * (TEST_RECORD_TIME_MS / 1000); // 96KB for 3s
